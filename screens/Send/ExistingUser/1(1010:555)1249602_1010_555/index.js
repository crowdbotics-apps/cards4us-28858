...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_1010_556} />
      <View style={styles.View_1010_557} />
      <View style={styles.View_1010_558}>
        <View style={styles.View_1010_559}>
          <View style={styles.View_1010_560} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/01a3/6210/1049063388899b33290616eafbc5ef32"
            }}
            style={styles.ImageBackground_1010_561}
          />
          <View style={styles.View_1010_562} />
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1010_563}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1010_567}
        />
        <View style={styles.View_1010_572}>
          <View style={styles.View_1010_573}>
            <Text style={styles.Text_1010_573}>9:41</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_1010_574}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/727e/928b/9143c608085b4fcd5703d91ef434bcee"
          }}
          style={styles.ImageBackground_1010_575}
        />
        <View style={styles.View_1010_577}>
          <View style={styles.View_1010_578}>
            <Text style={styles.Text_1010_578}>Back</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_1010_724}>
        <View style={styles.View_1010_725}>
          <View style={styles.View_1010_726}>
            <View style={styles.View_1010_727} />
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/ae2c/80f7/aeccf3eacc80a38c6b76d099f629782d"
              }}
              style={styles.ImageBackground_1010_728}
            />
          </View>
          <View style={styles.View_1010_729}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/b45d/7ce9/f6f13995e1503107d165f6bc27ed7d1a"
              }}
              style={styles.ImageBackground_1010_730}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_1010_731}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_1010_733}
            />
          </View>
          <ImageBackground
            source={{
            ...
            style={styles.ImageBackground_1010_734}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1010_738}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1010_742}
          />
          <View style={styles.View_1010_744}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/cd8c/6dd0/d79a32f86f41c8856b505f4489e1f61f"
              }}
              style={styles.ImageBackground_1010_745}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_1010_747}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_1010_750}
            />
          </View>
        </View>
        <View style={styles.View_1010_753}>
          <Text style={styles.Text_1010_753}>Favour Adamu</Text>
        </View>
        <View style={styles.View_1010_754}>
          <Text style={styles.Text_1010_754}>+2347035647893</Text>
        </View>
        <View style={styles.View_1010_755}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/5c45/7cda/fc1406aa69533570b77be18c5450b849"
            }}
            style={styles.ImageBackground_1010_756}
          />
        </View>
      </View>
      <View style={styles.View_1012_2091}>
        <View style={styles.View_1012_2092}>
          <Text style={styles.Text_1012_2092}>You’re sending money to</Text>
        </View>
      </View>
      <View style={styles.View_1010_761}>
        <View style={styles.View_1012_2109}>
          <View style={styles.View_1010_762}>
            <Text style={styles.Text_1010_762}>Kachi Ibeji</Text>
          </View>
          <View style={styles.View_1012_2094}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/e291/00ad/68825776c09bb837bdb0ce0fc6c06315"
              }}
              style={styles.ImageBackground_1012_2095}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_1012_2097}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_1012_2099}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_1012_2101}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_1012_2103}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_1012_2105}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_1012_2107}
            />
          </View>
        </View>
        <View style={styles.View_1010_763}>
          <Text style={styles.Text_1010_763}>@kachiibeji44</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1010_764}
        />
      </View>
      <View style={styles.View_1012_2112}>
        <View style={styles.View_1012_2110}>
          <Text style={styles.Text_1012_2110}>₦</Text>
        </View>
        <View style={styles.View_1012_2111}>
          <Text style={styles.Text_1012_2111}>0</Text>
        </View>
      </View>
      <View style={styles.View_1012_2132}>
        <View style={styles.View_1012_2133}>
          <View style={styles.View_1012_2134}>
            <View style={styles.View_1012_2135}>
              <Text style={styles.Text_1012_2135}>1</Text>
            </View>
            <View style={styles.View_1012_2136}>
              <Text style={styles.Text_1012_2136}>2</Text>
            </View>
            <View style={styles.View_1012_2137}>
              <Text style={styles.Text_1012_2137}>3</Text>
            </View>
          </View>
          <View style={styles.View_1012_2138}>
            <View style={styles.View_1012_2139}>
              <Text style={styles.Text_1012_2139}>4</Text>
            </View>
            <View style={styles.View_1012_2140}>
              <Text style={styles.Text_1012_2140}>5</Text>
            </View>
            <View style={styles.View_1012_2141}>
              <Text style={styles.Text_1012_2141}>6</Text>
            </View>
          </View>
          <View style={styles.View_1012_2142}>
            <View style={styles.View_1012_2143}>
              <Text style={styles.Text_1012_2143}>7</Text>
            </View>
            <View style={styles.View_1012_2144}>
              <Text style={styles.Text_1012_2144}>8</Text>
            </View>
            <View style={styles.View_1012_2145}>
              <Text style={styles.Text_1012_2145}>9</Text>
            </View>
          </View>
          <View style={styles.View_1012_2146}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/b09c/fb13/9bf2b489b610c906923e5fca6a3d6094"
              }}
              style={styles.ImageBackground_1012_2147}
            />
            <View style={styles.View_1012_2149}>
              <Text style={styles.Text_1012_2149}>0</Text>
            </View>
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_1012_2150}
            />
          </View>
        </View>
      </View>
      <View style={styles.View_1012_2152}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/5f59/9371/6c3203c8d7863cf50f3f4d466d99f855"
          }}
          style={styles.ImageBackground_1012_2153}
        />
        <View style={styles.View_1012_2154}>
          <Text style={styles.Text_1012_2154}>Continue</Text>
        </View>
      </View>
    </ScrollView>
  )
...
const styles = StyleSheet.create({
  ...
  View_1010_729: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("1.3319522286382846%"),
    backgroundColor: "rgba(0, 0, 0, 0)"
  },
  ImageBackground_1010_730: {
    width: wp("6.54075687058306%"),
    height: hp("4.93153275036421%"),
    top: hp("0%"),
    marginLeft: 0,
  ...
  ImageBackground_1010_731: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("3.2098005359299506%")
  },
  ImageBackground_1010_733: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("2.1186275758605078%")
  },
  ImageBackground_1010_734: {
  ...
  ImageBackground_1012_2095: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("1.5025558103109944%")
  },
  ImageBackground_1012_2097: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("1.5011994735054301%")
  },
  ImageBackground_1012_2099: {
