...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_948_1} />
      <View style={styles.View_948_2} />
      <View style={styles.View_948_3}>
        <View style={styles.View_948_4}>
          <View style={styles.View_948_5} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/01a3/6210/1049063388899b33290616eafbc5ef32"
            }}
            style={styles.ImageBackground_948_6}
          />
          <View style={styles.View_948_7} />
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_948_8}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_948_12}
        />
        <View style={styles.View_948_17}>
          <View style={styles.View_948_18}>
            <Text style={styles.Text_948_18}>9:41</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_948_19}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/727e/928b/9143c608085b4fcd5703d91ef434bcee"
          }}
          style={styles.ImageBackground_948_20}
        />
        <View style={styles.View_948_22}>
          <View style={styles.View_948_23}>
            <Text style={styles.Text_948_23}>Back</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_948_24}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/5f59/9371/6c3203c8d7863cf50f3f4d466d99f855"
          }}
          style={styles.ImageBackground_948_25}
        />
        <View style={styles.View_948_26}>
          <Text style={styles.Text_948_26}>Continue</Text>
        </View>
      </View>
      <View style={styles.View_948_27}>
        <Text style={styles.Text_948_27}>Use Email Address/mobile number</Text>
      </View>
      <View style={styles.View_948_28}>
        <View style={styles.View_948_29} />
        <View style={styles.View_948_30}>
          <Text style={styles.Text_948_30}>
            Enter Email Address/mobile number
          </Text>
        </View>
        <View style={styles.View_973_0}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2294/65b9/1a41926c50650227617d73a69f322374"
            }}
            style={styles.ImageBackground_973_1}
          />
        </View>
      </View>
    </ScrollView>
