...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_919_529} />
      <View style={styles.View_919_530} />
      <View style={styles.View_919_531}>
        <View style={styles.View_919_532}>
          <View style={styles.View_919_533} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/01a3/6210/1049063388899b33290616eafbc5ef32"
            }}
            style={styles.ImageBackground_919_534}
          />
          <View style={styles.View_919_535} />
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_919_536}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_919_540}
        />
        <View style={styles.View_919_545}>
          <View style={styles.View_919_546}>
            <Text style={styles.Text_919_546}>9:41</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_919_547}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/727e/928b/9143c608085b4fcd5703d91ef434bcee"
          }}
          style={styles.ImageBackground_919_548}
        />
        <View style={styles.View_919_550}>
          <View style={styles.View_919_551}>
            <Text style={styles.Text_919_551}>Back</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_919_552}>
        <Text style={styles.Text_919_552}>
          What account do you want to withdraw to?
        </Text>
      </View>
      <View style={styles.View_919_553}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/974a/980c/5eebc7052f15c9dd6e9c3d0b232e233a"
          }}
          style={styles.ImageBackground_919_554}
        />
        <View style={styles.View_919_555}>
          <Text style={styles.Text_919_555}>Withdraw money</Text>
        </View>
      </View>
      <View style={styles.View_919_572}>
        <View style={styles.View_919_573} />
        <View style={styles.View_919_574}>
          <View style={styles.View_919_575}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/3c63/0244/a5967ba87dcd09bc044366dc52423c04"
              }}
              style={styles.ImageBackground_919_576}
            />
          </View>
          <View style={styles.View_919_580}>
            <Text style={styles.Text_919_580}>Add New Bank account</Text>
          </View>
        </View>
      </View>
    </ScrollView>
