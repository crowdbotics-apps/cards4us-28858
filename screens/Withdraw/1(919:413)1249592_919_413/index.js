...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_919_414} />
      <View style={styles.View_919_415} />
      <View style={styles.View_919_416}>
        <View style={styles.View_919_417}>
          <View style={styles.View_919_418} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/01a3/6210/1049063388899b33290616eafbc5ef32"
            }}
            style={styles.ImageBackground_919_419}
          />
          <View style={styles.View_919_420} />
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_919_421}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_919_425}
        />
        <View style={styles.View_919_430}>
          <View style={styles.View_919_431}>
            <Text style={styles.Text_919_431}>9:41</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_919_432}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/727e/928b/9143c608085b4fcd5703d91ef434bcee"
          }}
          style={styles.ImageBackground_919_433}
        />
        <View style={styles.View_919_435}>
          <View style={styles.View_919_436}>
            <Text style={styles.Text_919_436}>Back</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_919_437}>
        <Text style={styles.Text_919_437}>How much do you want withdraw?</Text>
      </View>
      <View style={styles.View_919_438}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/974a/980c/5eebc7052f15c9dd6e9c3d0b232e233a"
          }}
          style={styles.ImageBackground_919_439}
        />
        <View style={styles.View_919_440}>
          <Text style={styles.Text_919_440}>Continue</Text>
        </View>
      </View>
      <View style={styles.View_919_441}>
        <View style={styles.View_919_442}>
          <Text style={styles.Text_919_442}>Minimum Amount ₦500</Text>
        </View>
        <View style={styles.View_919_443}>
          <View style={styles.View_919_444} />
          <View style={styles.View_919_445}>
            <Text style={styles.Text_919_445}>₦5,000</Text>
          </View>
        </View>
        <View style={styles.View_919_446}>
          <View style={styles.View_919_447} />
          <View style={styles.View_919_448}>
            <Text style={styles.Text_919_448}>₦10,000</Text>
          </View>
        </View>
        <View style={styles.View_919_449}>
          <View style={styles.View_919_450} />
          <View style={styles.View_919_451}>
            <Text style={styles.Text_919_451}>₦20,000</Text>
          </View>
        </View>
        <View style={styles.View_919_452}>
          <Text style={styles.Text_919_452}>Service Charge ₦50</Text>
        </View>
        <View style={styles.View_919_453}>
          <View style={styles.View_919_454}>
            <Text style={styles.Text_919_454}>₦</Text>
          </View>
          <View style={styles.View_919_455}>
            <Text style={styles.Text_919_455}>1,000</Text>
          </View>
          <View style={styles.View_919_456}>
            <Text style={styles.Text_919_456}>Amount</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_919_457}
          />
        </View>
      </View>
    </ScrollView>
