...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_1041_385} />
      <View style={styles.View_1041_386} />
      <View style={styles.View_1041_387}>
        <View style={styles.View_1041_388}>
          <View style={styles.View_1041_389} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/01a3/6210/1049063388899b33290616eafbc5ef32"
            }}
            style={styles.ImageBackground_1041_390}
          />
          <View style={styles.View_1041_391} />
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1041_392}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1041_396}
        />
        <View style={styles.View_1041_401}>
          <View style={styles.View_1041_402}>
            <Text style={styles.Text_1041_402}>9:41</Text>
          </View>
        </View>
      </View>
      <TouchableOpacity
        style={styles.TouchableOpacity_1041_403}
        onPress={() =>
      ...
      >
        <ImageBackground
          ...
          style={styles.ImageBackground_1041_404}
        />
        <View style={styles.View_1041_406}>
          <View style={styles.View_1041_407}>
            <Text style={styles.Text_1041_407}>Back to home</Text>
          </View>
        </View>
      </TouchableOpacity>
      <View style={styles.View_1041_408}>
        <View style={styles.View_1041_409}>
          <Text style={styles.Text_1041_409}>Congratulations</Text>
        </View>
        <View style={styles.View_1041_410}>
          <Text style={styles.Text_1041_410}>
            We’ve sent your requests to Kachi Ibeji
          </Text>
        </View>
      </View>
      <View style={styles.View_1041_411}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/fc51/c6e9/48134b8cb9081711b0970a2b017cd134"
          }}
          style={styles.ImageBackground_1041_412}
        />
        <View style={styles.View_1041_413}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7190/a502/536f7d8d5849470a1d42e2e6a99ded52"
            }}
            style={styles.ImageBackground_1041_414}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1041_415}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1041_416}
          />
        </View>
        <ImageBackground
          source={{
          ...
          style={styles.ImageBackground_1041_417}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1041_418}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1041_419}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1041_420}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1041_421}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1041_422}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1041_423}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1041_424}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1041_425}
        />
      </View>
      <View style={styles.View_1041_426}>
        <View style={styles.View_1041_427}>
          <View style={styles.View_1041_428}>
            <View style={styles.View_1041_429}>
              <View style={styles.View_1041_430}>
                <ImageBackground
                  source={{
                    uri:
                      "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/37b1/a5b6/088e3316ccabdd73ba10ac6143fea272"
                  }}
                  style={styles.ImageBackground_1041_431}
                />
                <ImageBackground
                  source={{
                    uri:
                  ...
                  style={styles.ImageBackground_1041_432}
                />
                <ImageBackground
                  source={{
                    uri:
                  ...
                  style={styles.ImageBackground_1041_433}
                />
                <ImageBackground
                  source={{
                    uri:
                  ...
                  style={styles.ImageBackground_1041_434}
                />
                <ImageBackground
                  source={{
                    uri:
                  ...
                  style={styles.ImageBackground_1041_435}
                />
                <ImageBackground
                  source={{
                    uri:
                  ...
                  style={styles.ImageBackground_1041_436}
                />
                <ImageBackground
                  source={{
                    uri:
                  ...
                  style={styles.ImageBackground_1041_437}
                />
                <ImageBackground
                  source={{
                    uri:
                  ...
                  style={styles.ImageBackground_1041_438}
                />
                <View style={styles.View_1041_439}>
                  <ImageBackground
                    source={{
                      uri:
                        "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/529e/e351/f885eb7da920f8b12c3753b6cc2a21da"
                    }}
                    style={styles.ImageBackground_1041_440}
                  />
                  <ImageBackground
                    source={{
                      uri:
                        "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/bbf3/596a/05aab8cebd075cae10920eb8d064e745"
                    }}
                    style={styles.ImageBackground_1041_443}
                  />
                </View>
                <ImageBackground
                  source={{
                  ...
                  style={styles.ImageBackground_1041_446}
                />
              </View>
              <View style={styles.View_1041_447}>
                <View style={styles.View_1041_448} />
                <View style={styles.View_1041_449} />
                <View style={styles.View_1041_450} />
                <View style={styles.View_1041_451} />
                <View style={styles.View_1041_452} />
                <View style={styles.View_1041_453} />
                <View style={styles.View_1041_454} />
                <View style={styles.View_1041_455} />
                <View style={styles.View_1041_456} />
                <View style={styles.View_1041_457} />
                <View style={styles.View_1041_458} />
                <View style={styles.View_1041_459} />
                <View style={styles.View_1041_460} />
                <View style={styles.View_1041_461} />
                <View style={styles.View_1041_462} />
                <View style={styles.View_1041_463} />
                <View style={styles.View_1041_464} />
                <View style={styles.View_1041_465} />
                <View style={styles.View_1041_466} />
              </View>
              <ImageBackground
                source={{
                  uri:
                ...
                style={styles.ImageBackground_1041_467}
              />
            </View>
          </View>
        </View>
