...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_1430_1} />
      <View style={styles.View_1430_2} />
      <View style={styles.View_1430_3}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/19ab/62ec/a172e73f04a13582852ce69134c6f61c"
          }}
          style={styles.ImageBackground_1430_4}
        />
        <View style={styles.View_1430_7}>
          <View style={styles.View_1430_8}>
            <Text style={styles.Text_1430_8}>Back</Text>
          </View>
        </View>
      </View>
      <View style={styles.View_1430_9}>
        <View style={styles.View_1430_10}>
          <View style={styles.View_1430_11} />
        </View>
        <View style={styles.View_1432_0}>
          <View style={styles.View_1432_1} />
          <View style={styles.View_1432_2}>
            <Text style={styles.Text_1432_2}>Choose a first question</Text>
          </View>
          <View style={styles.View_1432_3}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/3fdf/c7ac/a24e5748aeb27be3c01545f48586e8fd"
              }}
              style={styles.ImageBackground_1432_4}
            />
          </View>
        </View>
        <View style={styles.View_1432_7}>
          <View style={styles.View_1432_8} />
          <View style={styles.View_1432_9}>
            <Text style={styles.Text_1432_9}>Choose a second question</Text>
          </View>
          <View style={styles.View_1432_10}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/3fdf/c7ac/a24e5748aeb27be3c01545f48586e8fd"
              }}
              style={styles.ImageBackground_1432_11}
            />
          </View>
        </View>
        <View style={styles.View_1432_14}>
          <View style={styles.View_1432_15} />
          <View style={styles.View_1432_16}>
            <Text style={styles.Text_1432_16}>Enter your answer</Text>
          </View>
        </View>
        <View style={styles.View_1432_17}>
          <View style={styles.View_1432_18} />
          <View style={styles.View_1432_19}>
            <Text style={styles.Text_1432_19}>Enter your answer</Text>
          </View>
        </View>
        <View style={styles.View_1430_19}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/10dd/c7d5/418476e7d6d95ba17daa70d792950430"
            }}
            style={styles.ImageBackground_1430_20}
          />
          <View style={styles.View_1430_21}>
            <Text style={styles.Text_1430_21}>Set up 2FA</Text>
          </View>
        </View>
        <View style={styles.View_1430_29}>
          <Text style={styles.Text_1430_29}>2FA - Security question</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1430_30}
        />
      </View>
      <View style={styles.View_1430_31}>
        <View style={styles.View_1430_32}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/8864/5706/b6e6c96bf3ffe8496e3826c06996d6fc"
            }}
            style={styles.ImageBackground_1430_33}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_35}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_37}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_39}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_41}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_43}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_45}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_47}
          />
        </View>
        <View style={styles.View_1430_49}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/1c20/1f66/d9c9e278033ee719972ccdc03c1068f8"
            }}
            style={styles.ImageBackground_1430_50}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_52}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_54}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_56}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_58}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_60}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_1430_62}
          />
        </View>
      </View>
      <View style={styles.View_1430_64}>
        <View style={styles.View_1430_65}>
          <View style={styles.View_1430_66} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
            }}
            style={styles.ImageBackground_1430_67}
          />
          <View style={styles.View_1430_68} />
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1430_69}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_1430_73}
        />
        <View style={styles.View_1430_78}>
          <View style={styles.View_1430_79}>
            <Text style={styles.Text_1430_79}>9:41</Text>
          </View>
        </View>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  View_1430_9: {
    ...
    height: hp("68.44262295081968%"),
    minHeight: hp("68.44262295081968%"),
    marginLeft: 0,
    marginTop: 0,
    position: "absolute",
    left: wp("4.830917874396135%"),
  ...
  View_1432_3: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("75.2680534325936%"),
    backgroundColor: "rgba(0, 0, 0, 0)",
    overflow: "hidden"
  },
  ImageBackground_1432_4: {
    width: wp("4.830917874396135%"),
    height: hp("2.73224043715847%"),
    top: hp("0%"),
    marginLeft: 0,
